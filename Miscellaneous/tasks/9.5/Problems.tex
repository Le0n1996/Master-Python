...
\hypertarget{9.5}{{\centering\section*{\bigskip\\\textcolor{Blue}{\hyperlink{start2}{\textcolor{Blue}{9.5}} Степенные функции.}\vspace{-5mm}}}}

\begin{problem}{Степень с рациональным показателем.}{9.5.4}{9I}{(лёгкая)}
...
\begin{problem}{Степень с рациональным показателем.}{9.5.4}{9D}{(лёгкая)}
{Решить уравнение: $\;2\sqrt[3]{x + 1} - \sqrt[6]{x + 1} = 6$.}
{НаписанноеРешение}
{ВерныйОтвет}{Подсказка}
\end{problem}

\begin{problem}{Преобразования иррациональных выражений.}{9.5.5}{9D}{(лёгкая)}
...
\begin{problem}{Свойства и графики степенной функции.}{9.5.6}{9I}{*}
